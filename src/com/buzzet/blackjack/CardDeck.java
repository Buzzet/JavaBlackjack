...
@Getter public class CardDeck {
    ...
    public CardDeck() {
        final Card[] init = { Card.builder().color(CardColor.Heart).face(CardFace.TWO).build(),
                ...
                Card.builder().color(CardColor.Heart).face(CardFace.ASS).build(),
                ...
                Card.builder().color(CardColor.Spade).face(CardFace.ASS).build(),
                ...
                Card.builder().color(CardColor.Diamond).face(CardFace.ASS).build(),
                ...
                Card.builder().color(CardColor.Club).face(CardFace.ASS).build() };
